...
var resList;
jQuery.getJSON("getBatchFileTaskItemStoreList.json?taskId="+taskId,function(data){
	var tempData={
...
$("#submit").on("click",function(e){
	e.preventDefault();
	var url = Util.getUrlParam("fileType") == "3" ? "commitBatchFileTaskStore.json" : "commitBatchFileTaskStoreSkuPriceByProductCode.json";
