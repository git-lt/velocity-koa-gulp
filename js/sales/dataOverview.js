var DO = function(){
	this.pickStartDay = null;
	this.pickEndDay = null;
	this.pickers = {};
	this.getSupplierDataBetweenUrl = '../admin/getSupplierDataBetween.json';
	this.getSupplierDataStatListUrl = '../admin/getSupplierDataStatList.json';
};
...
DO.prototype = {
    ...
    loadData: function(sTime, eTime, sel,timeSpace,sTime2){
    	var _this = this;
    	/*console.log(sTime2,sel)*/
    	if (sel==0) {
    		sTimeT = sTime2;
    		eTimeY = eTime;
    	}
    	else if (sel==1) {
    		sTimeT = _this.getTimesBefore(1);
    		eTimeY = _this.getTimesEnd(0)+86400000;
    	}
    	else if (sel==2) {
    		sTimeT = _this.getTimesBefore(2);
    		eTimeY = _this.getTimesEnd(0);
    	}
    	else{
	    	sTimeT=sTime;
	    	eTimeY=eTime;
    	}
    	/*console.log(sTimeT,eTimeY)*/
    	$.ajax({
