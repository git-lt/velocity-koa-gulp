var DO = function(){
	...
	this.pickers = {};
	this.getCustomerFlashsaleDataBetweenUrl = '../admin/getCustomerFlashsaleDataBetween.json';
	this.geCustomerFlashsaleDataStatListUrl = '../admin/geCustomerFlashsaleDataStatList.json';
};
...
DO.prototype = {
    ...
    loadData: function(sTime, eTime, sel,timeSpace,sTime2){
    	...
    	$.ajax({
    		url: _this.getCustomerFlashsaleDataBetweenUrl,
            type: "post",
            data: {
    	...
    	$.ajax({
            url: _this.geCustomerFlashsaleDataStatListUrl,
            type: "post",
            data: {
            	token: getUrlParam("token"),
                startTime: sTime, 
            		...
            		if (timeSpace==undefined) {
            			$.each(res.result.statYmdVoList, function(j, item){
		                    ...
		                    switch(i+1){
		                    	...
		                    	case 1: val = item.pvCount;break;
		                    	case 2: val = item.uvCount;break;
		                    }
