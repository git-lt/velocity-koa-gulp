...
var DO = function(){
	...
	this.pickers = {};
	this.getStoreDataBetweenUrl = '../admin/getStoreDataBetween.json';
	this.getStoreDataStatListUrl = '../admin/getStoreDataStatList.json';
...
DO.prototype = {
    ...
    loadData: function(sTime, eTime, sel,timeSpace,sTime2,param){
    	...
    	$.ajax({
    		url: _this.getStoreDataBetweenUrl,
            type: "post",
            data: {
    	...
    	$.ajax({
            url: _this.getStoreDataStatListUrl,
            type: "post",
            data: {
            	token: getUrlParam("token"),
